...
- **3 hypothesis cycles max.** If 3 hypotheses are wrong, stop and tell the user: "I've tried 3 root-cause hypotheses and none panned out. Here's what I've ruled out: [list]. I need more context — can you describe exactly what you see when this fails?"
