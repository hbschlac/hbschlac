...
- **2026-05-27 — v3: expanded banned phrases and failure modes**
  - Added: "innovative", "spearheaded", "orchestrated", "championed", "synergy", "cross-functional", "stakeholder alignment", "drive [noun]" to banned phrases
  - Added: "no filler transitions" voice rule
  - Added: "resume voice" failure mode
