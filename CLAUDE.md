...
|-------|--------|-------------|
| code-builder | v7.4 | Parallel drafts, self-scoring, debug loop, visual mode |
...
| session-safety | v8 | Groundhog Day prevention, stacked PRs, handoff docs |
...
| testing-strategy | v1 | What to test, when to test, test patterns per stack |
| prd-to-code | v1 | PRD decomposition, PR sequencing, feature rounds |
...
4. ~~**No skill for PM workflows**~~ **RESOLVED**: prd-to-code v1 created 2026-06-07. Covers PRD decomposition, PR sequencing, feature rounds, handoff docs.
...
8. ~~**No testing strategy skill.**~~ **RESOLVED**: testing-strategy v1 created 2026-06-07. Covers what/when to test, test architecture per stack, mocking patterns, resilience testing.
9. **Non-Vercel deployment is partially covered.** kindle-connector deploys to k8s. code-builder v7.4 now has non-Vercel deployment learnings, but no dedicated deployment skill for k8s/Docker.
